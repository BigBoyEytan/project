...
class VirusTotalEngine:
    ...
    def scan_with_virustotal(self, file_path, file_hash) -> Dict[str, Any]:
    ...
    def _upload_file(self, file_path) -> Optional[Dict]:
        try:
    ...
    def _poll_analysis(self, analysis_id) -> Dict[str, Any]:
        try:
            for i in range(60):
    ...
    def _process_results(self, stats) -> Dict[str, Any]:
